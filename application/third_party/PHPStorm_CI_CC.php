<?php defined('BASEPATH') OR exit('No direct script access allowed');
	 ...
	 ***************** YOUR LIBRARIES *****************
	 * @property YelpApi   $yelpapi    YelpApi Class
	 ***************** YOUR MODELS *****************
     * @property user_m              		$user_m
	 * @property messenger_m		 		$messenger_m
     * @property trigger_m			 		$trigger_m
     * @property customer_m			 		$customer_m
     * @property requisition_listing_m	 	$requisition_listing_m
     * @property requisition_m		 		$requisition_m
     * @property requisition_messenger_m	$requisition_messenger_m
     * @property hrms_attendance_m			$hrms_attendance_m
     * @property hrms_salary_m				$hrms_salary_m
     * @property hrms_leave_m				$hrms_leave_m
     * @property hrms_message_m				$hrms_message_m
     * @property cac_type_m					$cac_type_m
     * @property app_m						$app_m
     * @property app_hrms_m					$app_hrms_m
     * @property hrms_leave_application_m	$hrms_leave_application_m
     * @property hrms_leave_entitlement_m	$hrms_leave_entitlement_m
     * @property hrms_leave_message_m		$hrms_leave_message_m
     * @property hrms_leave_type_m			$hrms_leave_type_m
	 * @property hrms_claim_title_m			$hrms_claim_title_m
	 * @property hrms_claim_details_m		$hrms_claim_details_m
	 * @property hrms_claim_message_m		$hrms_claim_message_m
	 * @property hrms_claim_type_m			$hrms_claim_type_m
	 * @property hrms_claim_detail_type_m	$hrms_claim_detail_type_m
     * @property hrms_claim_project_m      $hrms_claim_project_m
     * @property hrms_gst_m	                $hrms_gst_m
	 * @property hrms_timeoff_title_m		$hrms_timeoff_title_m
	 * @property hrms_timeoff_details_m		$hrms_timeoff_details_m
	 * @property hrms_timeoff_message_m		$hrms_timeoff_message_m
	 * @property hrms_timeoff_type_m		$hrms_timeoff_type_m
	 * @property hrms_letter_m				$hrms_letter_m
	 * @property hrms_letter_template_m		$hrms_letter_template_m
	 * @property hrms_letter_message_m		$hrms_letter_message_m
     *
	 * @property Hrms_alert_m		        $hrms_alert_m
	 * @property Hrms_emergency_leave_m		        $hrms_emergency_leave_m
	 * @property Hrms_payroll_m				$hrms_payroll_m
	 * @property Hrms_attendance_late_message_m		$hrms_attendance_late_message_m
     *
//	 */
	class CI_Controller {
